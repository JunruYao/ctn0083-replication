...
│   ├── 01_load_clean.R      # Load the data and build the analytic sample
│   ├── 02_table1.R          # Code for reproducing Table 1
│   ├── 03_primary_poisson.R # Code for the main Poisson models and contrasts
│   └── 04_secondary.R       # Code for reproducing Appendix 3 results
├── run_all.R                # script to run the whole pipeline from start to finish
├── SAP.docx                 # Statistical Analysis Plan
├── README.md                # Project overview and replication report
├── data/
│   └── CTN_FINAL.csv        # Final analysis-ready dataset (not included on GitHub)
├── output/                  # All tables and numeric results generated by the code
